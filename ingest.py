...
from cognitive_memory_api import CognitiveMemorySync
from cognitive_memory_api import MemoryInput as ApiMemoryInput
from cognitive_memory_api import MemoryType as ApiMemoryType
...
class MemoryExtractor:
    ...
    def _parse_response(
        self, response: str | None, chunk: DocumentChunk
            ...
            try:
                ...
                if memory_type == MemoryType.SEMANTIC:
                    ...
                    memory.emotional_valence = float(
                        mem_data.get("emotional_valence", 0.0)
                    )
                    ...
                    memory.context_applicability = mem_data.get(
        ...
        for m, h in items:
            ...
            if api_type == ApiMemoryType.EPISODIC:
                ...
                context = {
                    ...
                    "context_applicability": m.context_applicability,
                }
            ...
            inputs.append(
                ApiMemoryInput(
                    ...
                    if api_type == ApiMemoryType.SEMANTIC
                    else None,
                )
            )
            receipt_rows.append(
                {
                    "source_file": m.source_file,
                    "chunk_index": int(m.source_chunk),
                    "content_hash": h,
                }
            )
